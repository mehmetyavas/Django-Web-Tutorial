...
def Image_pre_save(self,instance,*args,**kwargs):
    pass
...
def CartItem_pre_save(sender, instance, *args, **kwargs):
...
pre_save.connect(CartItem_pre_save, sender=CartItem)



def CartItem_post_save(created, instance, *args, **kwargs):

    if created:
        instance.total_price =instance.quantity* instance.item.price
        instance.save()

post_save.connect(CartItem_post_save, sender=CartItem)
